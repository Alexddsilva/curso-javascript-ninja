(function () {
    ...
    */
    ...
    // ou  return operation[param] !== undefined
    // ou return (param === '+' || param === '-' || param === '*' || param === '/' || param === '%')
    ...
    */
    ...
    console.log('teste', calculator('-')(1, 2))
    ...
    */
    var showOpetarionMessage = function (operador, a, b) {
        return `A operação ${a} ${operador} ${b} =`;
    }
    console.log(showOpetarionMessage('+', 5, 10))
    ...
    */
    var showErrorMessage = function (operador) {
        if (!isOperatorValid(operador)) {
            return `Operação ${operador} inválida.`
        }
        return `Não há erros`
    }
    ...
    */
    if (sum) {
        number1 = 5;
        number2 = 10;
        console.log(showOpetarionMessage(operationSignal, number1, number2), sum(number1, number2))
    }
    else {
    ...
    */
    ...
    if (subtraction) {
        number1 = 5;
        number2 = 10;
        console.log(showOpetarionMessage(operationSignal, number1, number2), subtraction(number1, number2))
    }
    else {
        console.log(showErrorMessage(operationSignal))
    }
    ...
    if (division) {
        number1 = 5;
        number2 = 10;
        console.log(showOpetarionMessage(operationSignal, number1, number2), division(number1, number2))
    }
    else {
        console.log(showErrorMessage(operationSignal))
    }
    ...
    if (mod) {
        number1 = 5;
        number2 = 10;
        console.log(showOpetarionMessage(operationSignal, number1, number2), mod(number1, number2))
    }
    else {
        console.log(showErrorMessage(operationSignal))
    }
